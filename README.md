...
HKUST MATH2033 - Spring 2026

Instructor: [Prof. Hai Zhang](https://www.math.hkust.edu.hk/~haizhang/)

## About

This repository contains course materials and resources for MATH2033 Mathematical Analysis at HKUST.
...
```bash
git clone https://github.com/CriticalLine/MATH2033.git
```
...
All rights reserved by **HKUST**, the course instructors and original authors.
Please refer to the `LICENSE` files for more details.
